...
import ru.otus.hw.repositories.JpaBookCommentsRepository;
...
@DataJpaTest
@Import({BookCommentServiceImpl.class, JpaBookCommentsRepository.class,
        BookCommentMapperImpl.class, JpaBookRepository.class})
public class BookCommentServiceImplTest {
    ...
    void shouldReturnCorrectBookCommentsByBookId(Long bookId) {
        ...
        List<BookCommentDto> actualBookCommentsList = bookCommentService.findAllByBookId(bookId);
    ...
    void shouldDeleteBookCommentById(Long bookId) {
        assertThat(bookCommentService.findAllByBookId(bookId))
